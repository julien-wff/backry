<script lang="ts">
    ...
    let { opened, inputFieldArguments = $bindable(), fieldName }: Props = $props();
...
<p class="mb-2">
    The notification {fieldName.toLowerCase()} can be customized using an EJS template. For more information on EJS,
    see the
...
<p class="mb-4">
    ...
    You can modify it to test how the notification {fieldName.toLowerCase()} will look with different values.
</p>
...
<div class="collapse border-base-300 border mb-2">
    ...
    <div class="collapse-title font-semibold">{fieldName} EJS editor</div>
    <div class="collapse-content">
